...
board_t* board_create(uint_t size);
...
bool board_place_piece(board_t *board, point_t position, bool prevent_suicide);
bool board_move_piece(board_t *board, point_t src, point_t dst);
void board_potential_moves(board_t *board, point_t piece, list_point_t *potential_moves);
